		...
		<>
			{
				...
				<div className="fixed top-5 right-5 flex items-center w-full max-w-xs p-4 text-red-500 bg-white rounded-lg shadow dark:text-red-400 dark:bg-gray-800" role="alert">
					<div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-blue-500 bg-red-100 rounded-lg dark:bg-blue-800 dark:text-blue-200">
